...
import neiro.simple.mlp.old.ver2.dto.TrainResult;
...
public class Train {
     ...
     * @param batchSize - Только для пакетного режима обучения. Максимальный размер пачки
     * @return - новый текущий размер пачки*/
