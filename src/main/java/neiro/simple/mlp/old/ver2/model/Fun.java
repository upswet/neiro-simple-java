...
public class Fun {
    ...
    //без преобразования
    public static UnaryOperator<Double> IDENTITY  = (UnaryOperator<Double> & Serializable) x -> x;
    public static BiFunction<Double, Double, Double> IDENTITY_DERIVATIVE  = (BiFunction<Double, Double, Double> & Serializable) (iValue, oValue) -> 1.0;
    ...
    public static BiFunction<Double, Double, Double> LOSS_DERIVATIVE_MAE = (BiFunction<Double, Double, Double> & Serializable) (oValue, target) ->  oValue < target ? -1.0 : 1.0;
}
